...
-- -----------------------------------------------------
-- Table `storex`.`announces`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `storex`.`announces`
(
    `ID`          INT           NOT NULL AUTO_INCREMENT,
    ...
    PRIMARY KEY (`ID`),
    UNIQUE INDEX `ID_UNIQUE` (`ID` ASC) VISIBLE,
    INDEX `fk_announces_user1_idx` (`user_ID` ASC) VISIBLE,
    CONSTRAINT `fk_announces_user1`
        FOREIGN KEY (`user_ID`)
